...
public class CashierPanel implements Initializable {
    @Override
    ...
    public void goToSell(javafx.event.ActionEvent event) throws IOException {
        Parent schedulePanel= FXMLLoader.load(getClass().getResource("CashierPanel.fxml"));
    ...
    public void goToScheduleCashier(javafx.event.ActionEvent event) throws IOException {
        Parent schedulePanel= FXMLLoader.load(getClass().getResource("CashierSchedulePanel.fxml"));
        Scene scheduleScene= new Scene(schedulePanel);
