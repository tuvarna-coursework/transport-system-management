...
public class CompanyPanel implements Initializable {
    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {

    }
    public void goToAddTrip(javafx.event.ActionEvent event) throws IOException {
        Parent schedulePanel= FXMLLoader.load(getClass().getResource("CompanyAddTripPanel.fxml"));
    ...
    public void goToScheduleCompany(javafx.event.ActionEvent event) throws IOException {
        Parent schedulePanel= FXMLLoader.load(getClass().getResource("CompanySchedule.fxml"));
        Scene scheduleScene= new Scene(schedulePanel);
    ...
    public void goToRequest(javafx.event.ActionEvent event) throws IOException {
        Parent schedulePanel= FXMLLoader.load(getClass().getResource("CompanyRequestPanel.fxml"));
        Scene scheduleScene= new Scene(schedulePanel);
