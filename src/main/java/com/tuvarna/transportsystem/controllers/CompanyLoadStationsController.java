...
public class CompanyLoadStationsController implements Initializable {
    ...
    public void makeRoute(javafx.event.ActionEvent event) throws IOException {
        ...
        if (stationOneChoiceBox.getValue() != null && stationOneChoiceBox.getValue().trim().length() != 0) {
            ...
            Location locationStationOne = locationService
                    .getByName(st1).get();
            ...
            routeService.addAttachmentLocation(route,locationStationOne);
        }
        if (stationTwoChoiceBox.getValue()!=null && stationTwoChoiceBox.getValue().trim().length() != 0) {
            Location locationStationTwo = new LocationService()
                    .getByName(stationTwoChoiceBox.getValue().toString()).get();
            ...
            RouteService routeService = new RouteService();
            routeService.addAttachmentLocation(route,locationStationTwo);
        }
        if (stationThreeChoiceBox.getValue()!=null&& stationThreeChoiceBox.getValue().trim().length() != 0) {
            Location locationStationThree = new LocationService()
                    .getByName(stationThreeChoiceBox.getValue().toString()).get();
            ...
            RouteService routeService = new RouteService();
            routeService.addAttachmentLocation(route,locationStationThree);
        }
        if (stationFourChoiceBox.getValue() !=null && stationFourChoiceBox.getValue().trim().length() !=0) {
            Location locationStationFour = new LocationService()
                    .getByName(stationFourChoiceBox.getValue().toString()).get();
            ...
            RouteService routeService = new RouteService();
            routeService.addAttachmentLocation(route,locationStationFour);
        }
        if (stationFiveChoiceBox.getValue() !=null && stationFiveChoiceBox.getValue().trim().length() !=0) {
            Location locationStationFive = new LocationService()
                    .getByName(stationFiveChoiceBox.getValue().toString()).get();
            ...
            RouteService routeService = new RouteService();
            routeService.addAttachmentLocation(route,locationStationFive);
        }
        if (stationSixChoiceBox.getValue() !=null && stationSixChoiceBox.getValue().trim().length() !=0) {
            Location locationStationSix = new LocationService()
                    .getByName(stationSixChoiceBox.getValue().toString()).get();
            ...
            RouteService routeService = new RouteService();
            routeService.addAttachmentLocation(route,locationStationSix);
        }
        if (stationSevenChoiceBox.getValue() !=null && stationSevenChoiceBox.getValue().trim().length() !=0) {
            Location locationStationSeven = new LocationService()
                    .getByName(stationSevenChoiceBox.getValue().toString()).get();
            ...
            RouteService routeService = new RouteService();
            routeService.addAttachmentLocation(route,locationStationSeven);
        }
        if (stationEightChoiceBox.getValue() !=null && stationEightChoiceBox.getValue().trim().length() !=0) {
            Location locationStationEight = new LocationService()
                    .getByName(stationEightChoiceBox.getValue().toString()).get();
            ...
            RouteService routeService = new RouteService();
            routeService.addAttachmentLocation(route,locationStationEight);
        }
        if (stationNineChoiceBox.getValue() !=null && stationNineChoiceBox.getValue().trim().length() !=0) {
            Location locationStationNine = new LocationService()
                    .getByName(stationNineChoiceBox.getValue().toString()).get();
            ...
            RouteService routeService = new RouteService();
            routeService.addAttachmentLocation(route,locationStationNine);
        }
        if (stationTenChoiceBox.getValue() !=null && stationTenChoiceBox.getValue().trim().length() !=0) {
            Location locationStationTen = new LocationService()
                    .getByName(stationTenChoiceBox.getValue().toString()).get();
            ...
            RouteService routeService = new RouteService();
            routeService.addAttachmentLocation(route,locationStationTen);
        }
        if (stationElevenChoiceBox.getValue() !=null && stationElevenChoiceBox.getValue().trim().length() !=0) {
            ...
            RouteService routeService = new RouteService();
            routeService.addAttachmentLocation(route,locationStationEleven);
        }
        if (stationTwelveChoiceBox.getValue() !=null && stationTwelveChoiceBox.getValue().trim().length() !=0) {
            ...
            RouteService routeService = new RouteService();
            routeService.addAttachmentLocation(route,locationStationTwelve);
        }
       stage.close();
