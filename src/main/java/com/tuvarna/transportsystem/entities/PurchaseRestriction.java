...
public class PurchaseRestriction {
	...
	@OneToOne(mappedBy = "tripPurchaseRestriction")
	private Trip trip;
	...
	public int getPurchaseRestriction_id() {
		return purchaseRestriction_id;
	}

	public void setPurchaseRestriction_id(int purchaseRestriction_id) {
		this.purchaseRestriction_id = purchaseRestriction_id;
	}

	public String getPurchaseRestriction_name() {
		return purchaseRestriction_name;
	}

	public void setPurchaseRestriction_name(String purchaseRestriction_name) {
		this.purchaseRestriction_name = purchaseRestriction_name;
	}
}
